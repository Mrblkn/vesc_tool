...
public:
    ...
    {
        PageTerminal->setWindowTitle(QApplication::translate("PageTerminal", "Form", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("PageTerminal", "Send help command to VESC", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        helpButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        sendButton->setToolTip(QApplication::translate("PageTerminal", "Send command", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        sendButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        clearButton->setToolTip(QApplication::translate("PageTerminal", "Clear terminal", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
