...
public:
    ...
    {
        PageSettings->setWindowTitle(QApplication::translate("PageSettings", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("PageSettings", "UI Scale Factor (restart required)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        uiScaleBox->setToolTip(QApplication::translate("PageSettings", "<html><head/><body><p>Scale the user intefrace with this factor. Useful for high resolution monitors. VESC Tool must be restarted for this setting to take effect.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        uiAutoScaleBox->setToolTip(QApplication::translate("PageSettings", "<html><head/><body><p>Try to determine the scaling factor automatically from the screen resolution and the system font settings. VESC Tool must be restarted for this setting to take effect.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        uiAutoScaleBox->setText(QApplication::translate("PageSettings", "Auto", Q_NULLPTR));
    } // retranslateUi
