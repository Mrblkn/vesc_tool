...
public:
    ...
    {
        DetectFocEncoder->setWindowTitle(QApplication::translate("DetectFocEncoder", "Form", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("DetectFocEncoder", "Detect Encoder", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("DetectFocEncoder", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        helpButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        currentBox->setToolTip(QApplication::translate("DetectFocEncoder", "Open loop current to turn the motor with", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        currentBox->setPrefix(QApplication::translate("DetectFocEncoder", "I: ", Q_NULLPTR));
        currentBox->setSuffix(QApplication::translate("DetectFocEncoder", " A", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        startButton->setToolTip(QApplication::translate("DetectFocEncoder", "Start detection", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        startButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        offsetBox->setToolTip(QApplication::translate("DetectFocEncoder", "Encoder offset", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        offsetBox->setPrefix(QApplication::translate("DetectFocEncoder", "Offset: ", Q_NULLPTR));
        offsetBox->setSuffix(QString());
#ifndef QT_NO_TOOLTIP
        ratioBox->setToolTip(QApplication::translate("DetectFocEncoder", "Encoder ratio", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ratioBox->setPrefix(QApplication::translate("DetectFocEncoder", "Ratio: ", Q_NULLPTR));
        ratioBox->setSuffix(QString());
        invertedBox->clear();
        invertedBox->insertItems(0, QStringList()
         << QApplication::translate("DetectFocEncoder", "Not Inverted", Q_NULLPTR)
         << QApplication::translate("DetectFocEncoder", "Inverted", Q_NULLPTR)
        );
#ifndef QT_NO_TOOLTIP
        applyButton->setToolTip(QApplication::translate("DetectFocEncoder", "Apply detection result", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
