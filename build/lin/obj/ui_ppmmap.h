...
public:
    ...
    {
        PpmMap->setWindowTitle(QApplication::translate("PpmMap", "Form", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("PpmMap", "PPM Pulselength Mapping", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        controlTypeBox->setToolTip(QApplication::translate("PpmMap", "Choose the control type. Some control types have centered input, some don't.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("PpmMap", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        helpButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        applyButton->setToolTip(QApplication::translate("PpmMap", "Apply min, max and center to VESC Tool configuration", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        applyButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        minBox->setToolTip(QApplication::translate("PpmMap", "Measured minimum pulselength", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        minBox->setPrefix(QApplication::translate("PpmMap", "Min: ", Q_NULLPTR));
        minBox->setSuffix(QApplication::translate("PpmMap", " ms", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        maxBox->setToolTip(QApplication::translate("PpmMap", "Measured maximum pulselength", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        maxBox->setPrefix(QApplication::translate("PpmMap", "Max: ", Q_NULLPTR));
        maxBox->setSuffix(QApplication::translate("PpmMap", " ms", Q_NULLPTR));
        centerBox->setPrefix(QApplication::translate("PpmMap", "Center: ", Q_NULLPTR));
        centerBox->setSuffix(QApplication::translate("PpmMap", " ms", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        resetButton->setToolTip(QApplication::translate("PpmMap", "Reset min and max", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        resetButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("PpmMap", "VESC Tool preview with the current settings.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("PpmMap", "VESC Tool", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        display->setToolTip(QApplication::translate("PpmMap", "VESC Tool preview with the current settings.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("PpmMap", "Current VESC output. Will be updated after writing the app configuration.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("PpmMap", "From VESC", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        displayVesc->setToolTip(QApplication::translate("PpmMap", "Current VESC output. Will be updated after writing the app configuration.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
