...
public:
    ...
    {
        PageMotorInfo->setWindowTitle(QApplication::translate("PageMotorInfo", "Form", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("PageMotorInfo", "General", Q_NULLPTR));
        descriptionHelpButton->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("PageMotorInfo", "Description", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("PageMotorInfo", "Quality", Q_NULLPTR));
    } // retranslateUi
