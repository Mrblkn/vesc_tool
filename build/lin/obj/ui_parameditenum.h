...
public:
    ...
    {
        ParamEditEnum->setWindowTitle(QApplication::translate("ParamEditEnum", "Form", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        readButton->setToolTip(QApplication::translate("ParamEditEnum", "Read current setting", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        readButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        readDefaultButton->setToolTip(QApplication::translate("ParamEditEnum", "Read default setting", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        readDefaultButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("ParamEditEnum", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
