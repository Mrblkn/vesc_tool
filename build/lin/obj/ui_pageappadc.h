...
public:
    ...
    {
        PageAppAdc->setWindowTitle(QApplication::translate("PageAppAdc", "Form", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("PageAppAdc", "General", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("PageAppAdc", "Mapping", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("PageAppAdc", "Throttle Curve", Q_NULLPTR));
    } // retranslateUi
