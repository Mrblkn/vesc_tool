...
public:
    ...
    {
        PageSetupCalculators->setWindowTitle(QApplication::translate("PageSetupCalculators", "Form", Q_NULLPTR));
        addSetupButton->setText(QApplication::translate("PageSetupCalculators", "Add Setup", Q_NULLPTR));
        removeSetupButton->setText(QApplication::translate("PageSetupCalculators", "Remove Setup", Q_NULLPTR));
    } // retranslateUi
