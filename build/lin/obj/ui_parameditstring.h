...
public:
    ...
    {
        ParamEditString->setWindowTitle(QApplication::translate("ParamEditString", "Form", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("ParamEditString", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
