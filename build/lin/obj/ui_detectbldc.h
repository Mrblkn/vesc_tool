...
public:
    ...
    {
        DetectBldc->setWindowTitle(QApplication::translate("DetectBldc", "Form", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("DetectBldc", "Detect BLDC Parameters", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        dutyBox->setToolTip(QApplication::translate("DetectBldc", "Duty cycle to measure BEMF coupling at", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        dutyBox->setPrefix(QApplication::translate("DetectBldc", "D: ", Q_NULLPTR));
        dutyBox->setSuffix(QString());
#ifndef QT_NO_TOOLTIP
        currentBox->setToolTip(QApplication::translate("DetectBldc", "Current to use for spinning up the motor", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        currentBox->setPrefix(QApplication::translate("DetectBldc", "I ", Q_NULLPTR));
        currentBox->setSuffix(QApplication::translate("DetectBldc", " A", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        applyButton->setToolTip(QApplication::translate("DetectBldc", "Apply detection results", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        applyButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        erpmBox->setToolTip(QApplication::translate("DetectBldc", "Min ERPM setting for delay commutation mode to use", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        erpmBox->setPrefix(QApplication::translate("DetectBldc", "\317\211 ", Q_NULLPTR));
        erpmBox->setSuffix(QApplication::translate("DetectBldc", " ERPM", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("DetectBldc", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        helpButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        runButton->setToolTip(QApplication::translate("DetectBldc", "Start detection", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
