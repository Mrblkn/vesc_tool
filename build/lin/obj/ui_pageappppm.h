...
public:
    ...
    {
        PageAppPpm->setWindowTitle(QApplication::translate("PageAppPpm", "Form", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("PageAppPpm", "General", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("PageAppPpm", "Mapping", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("PageAppPpm", "Throttle Curve", Q_NULLPTR));
    } // retranslateUi
