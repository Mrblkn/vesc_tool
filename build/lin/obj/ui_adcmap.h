...
public:
    ...
    {
        AdcMap->setWindowTitle(QApplication::translate("AdcMap", "Form", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("AdcMap", "ADC Voltage Mapping", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        controlTypeBox->setToolTip(QApplication::translate("AdcMap", "Choose the control type. Some control types have centered input, some don't.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("AdcMap", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        helpButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        resetButton->setToolTip(QApplication::translate("AdcMap", "Reset min and max", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        resetButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        applyButton->setToolTip(QApplication::translate("AdcMap", "Apply min and max to configuration", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        applyButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        maxCh2Box->setToolTip(QApplication::translate("AdcMap", "Measured maximum voltage", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        maxCh2Box->setPrefix(QApplication::translate("AdcMap", "Max: ", Q_NULLPTR));
        maxCh2Box->setSuffix(QString());
#ifndef QT_NO_TOOLTIP
        minCh1Box->setToolTip(QApplication::translate("AdcMap", "Measured minimum voltage", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        minCh1Box->setPrefix(QApplication::translate("AdcMap", "Min: ", Q_NULLPTR));
        minCh1Box->setSuffix(QString());
#ifndef QT_NO_TOOLTIP
        maxCh1Box->setToolTip(QApplication::translate("AdcMap", "Measured maximum voltage", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        maxCh1Box->setPrefix(QApplication::translate("AdcMap", "Max: ", Q_NULLPTR));
        maxCh1Box->setSuffix(QString());
        label->setText(QApplication::translate("AdcMap", "CH1 ", Q_NULLPTR));
        label_2->setText(QApplication::translate("AdcMap", "CH2 ", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        minCh2Box->setToolTip(QApplication::translate("AdcMap", "Measured minimum voltage", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        minCh2Box->setPrefix(QApplication::translate("AdcMap", "Min: ", Q_NULLPTR));
        minCh2Box->setSuffix(QString());
#ifndef QT_NO_TOOLTIP
        centerCh1Box->setToolTip(QApplication::translate("AdcMap", "Measured minimum voltage", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        centerCh1Box->setPrefix(QApplication::translate("AdcMap", "Center: ", Q_NULLPTR));
