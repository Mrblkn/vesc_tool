...
public:
    ...
    {
        PageRtData->setWindowTitle(QApplication::translate("PageRtData", "Form", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("PageRtData", "Current", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        tempShowMosfetBox->setToolTip(QApplication::translate("PageRtData", "Show MOSFET temperature", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        tempShowMosfetBox->setText(QApplication::translate("PageRtData", "MOSFET", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        tempShowMotorBox->setToolTip(QApplication::translate("PageRtData", "Show motor temperature", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        tempShowMotorBox->setText(QApplication::translate("PageRtData", "Motor", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("PageRtData", "Temperature", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("PageRtData", "RPM", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("PageRtData", "FOC", Q_NULLPTR));
        posBar->setFormat(QApplication::translate("PageRtData", "%v Degrees", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        posInductanceButton->setToolTip(QApplication::translate("PageRtData", "Start inductance based signal injection detection (BLDC only)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        posInductanceButton->setText(QApplication::translate("PageRtData", "Inductance", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        posEncoderButton->setToolTip(QApplication::translate("PageRtData", "Plot the encoder position", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        posEncoderButton->setText(QApplication::translate("PageRtData", "Encoder", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        posObserverButton->setToolTip(QApplication::translate("PageRtData", "Plot the rotor position seen by the observer (FOC only)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        posObserverButton->setText(QApplication::translate("PageRtData", "Observer", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        posPidButton->setToolTip(QApplication::translate("PageRtData", "Plot the PID controller position", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        posPidButton->setText(QApplication::translate("PageRtData", "PID Pos", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        posEncoderObserverErrorButton->setToolTip(QApplication::translate("PageRtData", "Plot the difference between the observer and encoder position (FOC only)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        posEncoderObserverErrorButton->setText(QApplication::translate("PageRtData", "Observer Error", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        posPidErrorButton->setToolTip(QApplication::translate("PageRtData", "Plot the PID controller position error", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        posPidErrorButton->setText(QApplication::translate("PageRtData", "PID Error", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        posStopButton->setToolTip(QApplication::translate("PageRtData", "Stop sending position samples", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        posStopButton->setText(QApplication::translate("PageRtData", "Stop", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("PageRtData", "Rotor Position", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        autoscaleButton->setToolTip(QApplication::translate("PageRtData", "Autoscale plots with incoming samples", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        autoscaleButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        zoomHButton->setToolTip(QApplication::translate("PageRtData", "Enable horizontal zoom", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        zoomHButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        zoomVButton->setToolTip(QApplication::translate("PageRtData", "Enable vertical zoom", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        zoomVButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        rescaleButton->setToolTip(QApplication::translate("PageRtData", "Rescale plots to fit", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
