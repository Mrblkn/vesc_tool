...
public:
    ...
    {
        PageFirmware->setWindowTitle(QApplication::translate("PageFirmware", "Form", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("PageFirmware", "Install New Firmware", Q_NULLPTR));
        label->setText(QApplication::translate("PageFirmware", "Hardware Version", Q_NULLPTR));
        label_2->setText(QApplication::translate("PageFirmware", "Firmware", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        showNonDefaultBox->setToolTip(QApplication::translate("PageFirmware", "Show firmwares with non-default compilation options", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        showNonDefaultBox->setText(QApplication::translate("PageFirmware", "Show non-default firmwares", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        changelogButton->setToolTip(QApplication::translate("PageFirmware", "Show firmware changelog", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        changelogButton->setText(QString());
        fwTabWidget->setTabText(fwTabWidget->indexOf(tab), QApplication::translate("PageFirmware", "Included Files", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        chooseButton->setToolTip(QApplication::translate("PageFirmware", "Choose file...", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        chooseButton->setText(QString());
        fwTabWidget->setTabText(fwTabWidget->indexOf(tab_2), QApplication::translate("PageFirmware", "Custom File", Q_NULLPTR));
        fwTabWidget->setTabText(fwTabWidget->indexOf(tab_3), QApplication::translate("PageFirmware", "Bootloader", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        cancelButton->setToolTip(QApplication::translate("PageFirmware", "Cancel upload", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        cancelButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        uploadButton->setToolTip(QApplication::translate("PageFirmware", "Update firmware on the connected VESC", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        uploadButton->setText(QString());
        groupBox_2->setTitle(QApplication::translate("PageFirmware", "VESC Firmware, Hardware and UUID", Q_NULLPTR));
        currentLabel->setText(QString());
#ifndef QT_NO_TOOLTIP
        readVersionButton->setToolTip(QApplication::translate("PageFirmware", "Read firmware version", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        readVersionButton->setText(QString());
        groupBox_3->setTitle(QApplication::translate("PageFirmware", "Supported Firmwares", Q_NULLPTR));
