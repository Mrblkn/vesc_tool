...
public:
    ...
    {
        ParamEditDouble->setWindowTitle(QApplication::translate("ParamEditDouble", "Form", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        readButton->setToolTip(QApplication::translate("ParamEditDouble", "Read current setting", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        readButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        readDefaultButton->setToolTip(QApplication::translate("ParamEditDouble", "Read default setting", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        readDefaultButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("ParamEditDouble", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
