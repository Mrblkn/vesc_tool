...
public:
    ...
    {
        ParamEditInt->setWindowTitle(QApplication::translate("ParamEditInt", "Form", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        readButton->setToolTip(QApplication::translate("ParamEditInt", "Read current setting", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        readButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        readDefaultButton->setToolTip(QApplication::translate("ParamEditInt", "Read default setting", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        readDefaultButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("ParamEditInt", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
