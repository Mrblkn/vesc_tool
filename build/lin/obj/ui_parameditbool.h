...
public:
    ...
    {
        ParamEditBool->setWindowTitle(QApplication::translate("ParamEditBool", "Form", Q_NULLPTR));
        valueBox->clear();
        valueBox->insertItems(0, QStringList()
         << QApplication::translate("ParamEditBool", "False", Q_NULLPTR)
         << QApplication::translate("ParamEditBool", "True", Q_NULLPTR)
        );
#ifndef QT_NO_TOOLTIP
        readButton->setToolTip(QApplication::translate("ParamEditBool", "Read current setting", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        readButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        readDefaultButton->setToolTip(QApplication::translate("ParamEditBool", "Read default setting", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        readDefaultButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("ParamEditBool", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
