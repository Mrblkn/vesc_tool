...
public:
    ...
    {
        PageFoc->setWindowTitle(QApplication::translate("PageFoc", "Form", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("PageFoc", "General", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("PageFoc", "Sensorless", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("PageFoc", "Hall Sensors", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("PageFoc", "Encoder", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("PageFoc", "Advanced", Q_NULLPTR));
    } // retranslateUi
