...
public:
    ...
    {
        PageDebugPrint->setWindowTitle(QApplication::translate("PageDebugPrint", "Form", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        clearButton->setToolTip(QApplication::translate("PageDebugPrint", "Clear all text from console", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
