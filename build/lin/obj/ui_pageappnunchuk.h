...
public:
    ...
    {
        PageAppNunchuk->setWindowTitle(QApplication::translate("PageAppNunchuk", "Form", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("PageAppNunchuk", "General", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("PageAppNunchuk", "Throttle Curve", Q_NULLPTR));
    } // retranslateUi
