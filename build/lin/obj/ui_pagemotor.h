...
public:
    ...
    void setupUi(QWidget *PageMotor)
    {
        ...
        wattageTab = new ParamTable(tab_7);
        wattageTab->setObjectName(QStringLiteral("wattageTab"));

        verticalLayout_8->addWidget(wattageTab);
    ...
    {
        PageMotor->setWindowTitle(QApplication::translate("PageMotor", "Form", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("PageMotor", "General", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("PageMotor", "Current", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("PageMotor", "Voltage", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_6), QApplication::translate("PageMotor", "RPM", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_7), QApplication::translate("PageMotor", "Wattage", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("PageMotor", "Temperature", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("PageMotor", "Advanced", Q_NULLPTR));
    } // retranslateUi
