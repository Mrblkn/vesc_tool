...
public:
    ...
    {
        DetectFoc->setWindowTitle(QApplication::translate("DetectFoc", "Form", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("DetectFoc", "Detect and Calculate Parameters", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        erpmBox->setToolTip(QApplication::translate("DetectFoc", "Open loop speed for delay mode BLDC commutation", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        erpmBox->setPrefix(QApplication::translate("DetectFoc", "\317\211: ", Q_NULLPTR));
        erpmBox->setSuffix(QApplication::translate("DetectFoc", " ERPM", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("DetectFoc", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        helpButton->setText(QString());
        pushButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        rlButton->setToolTip(QApplication::translate("DetectFoc", "Measure resistance and inductance", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        rlButton->setText(QString());
        pushButton_2->setText(QString());
#ifndef QT_NO_TOOLTIP
        lambdaButton->setToolTip(QApplication::translate("DetectFoc", "Measure flux linkage", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        lambdaButton->setText(QString());
        pushButton_3->setText(QString());
#ifndef QT_NO_TOOLTIP
        applyAllButton->setToolTip(QApplication::translate("DetectFoc", "Calculate and apply all parameters", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        applyAllButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        dutyBox->setToolTip(QApplication::translate("DetectFoc", "Duty cycle to sample at", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        dutyBox->setPrefix(QApplication::translate("DetectFoc", "D: ", Q_NULLPTR));
        dutyBox->setSuffix(QString());
        label_2->setText(QApplication::translate("DetectFoc", "\342\206\220 For \316\273", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        inductanceBox->setToolTip(QApplication::translate("DetectFoc", "Motor inductance", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        inductanceBox->setPrefix(QApplication::translate("DetectFoc", "L: ", Q_NULLPTR));
        inductanceBox->setSuffix(QApplication::translate("DetectFoc", " \302\265H", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        lambdaBox->setToolTip(QApplication::translate("DetectFoc", "Motor flux linkage", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        lambdaBox->setPrefix(QApplication::translate("DetectFoc", "\316\273: ", Q_NULLPTR));
        lambdaBox->setSuffix(QApplication::translate("DetectFoc", " mWb", Q_NULLPTR));
        label->setText(QApplication::translate("DetectFoc", "\342\206\220 Param", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        tcBox->setToolTip(QApplication::translate("DetectFoc", "Time constant for calculating KP and KI", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        tcBox->setPrefix(QApplication::translate("DetectFoc", "T: ", Q_NULLPTR));
        tcBox->setSuffix(QApplication::translate("DetectFoc", " \302\265S", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        kpBox->setToolTip(QApplication::translate("DetectFoc", "Current control KP", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        kpBox->setPrefix(QApplication::translate("DetectFoc", "KP: ", Q_NULLPTR));
        kpBox->setSuffix(QString());
#ifndef QT_NO_TOOLTIP
        kiBox->setToolTip(QApplication::translate("DetectFoc", "Current control KI", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        kiBox->setPrefix(QApplication::translate("DetectFoc", "KI: ", Q_NULLPTR));
        kiBox->setSuffix(QString());
        label_3->setText(QApplication::translate("DetectFoc", "\342\206\220 Calc", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        obsGainBox->setToolTip(QApplication::translate("DetectFoc", "Observer gain", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        obsGainBox->setPrefix(QApplication::translate("DetectFoc", "Observer Gain (x1M): ", Q_NULLPTR));
        obsGainBox->setSuffix(QString());
        label_4->setText(QApplication::translate("DetectFoc", "\342\206\220 Calc", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        currentBox->setToolTip(QApplication::translate("DetectFoc", "Current for starting", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        currentBox->setPrefix(QApplication::translate("DetectFoc", "I: ", Q_NULLPTR));
        currentBox->setSuffix(QApplication::translate("DetectFoc", " A", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        resistanceBox->setToolTip(QApplication::translate("DetectFoc", "Motor resistance", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        resistanceBox->setPrefix(QApplication::translate("DetectFoc", "R: ", Q_NULLPTR));
        resistanceBox->setSuffix(QApplication::translate("DetectFoc", " m\316\251", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        calcGainButton->setToolTip(QApplication::translate("DetectFoc", "Calculate Observer Gain (requires \316\273)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        calcGainButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        calcKpKiButton->setToolTip(QApplication::translate("DetectFoc", "Calculate KP and KI (requires R and L)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
