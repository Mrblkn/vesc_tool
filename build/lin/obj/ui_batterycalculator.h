...
public:
    ...
    {
        BatteryCalculator->setWindowTitle(QApplication::translate("BatteryCalculator", "Form", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("BatteryCalculator", "Battery Cutoff Calculator", Q_NULLPTR));
        label_2->setText(QApplication::translate("BatteryCalculator", "Type", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        batteryCalcButton->setToolTip(QApplication::translate("BatteryCalculator", "Apply calculated limits", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        batteryCalcButton->setText(QString());
        batteryTypeBox->clear();
        batteryTypeBox->insertItems(0, QStringList()
         << QApplication::translate("BatteryCalculator", "Lithium Ion (full at 4.2V/cell)", Q_NULLPTR)
        );
        batteryCutoffLabel->setText(QString());
        label_3->setText(QApplication::translate("BatteryCalculator", "Cells", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        helpButton->setToolTip(QApplication::translate("BatteryCalculator", "Show help", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
