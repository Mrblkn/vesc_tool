...
QT_MOC_LITERAL(8, 78, 14), // "VescInterface*"
QT_MOC_LITERAL(9, 93, 4), // "vesc"
QT_MOC_LITERAL(10, 98, 12), // "isBootloader"
QT_MOC_LITERAL(11, 111, 10) // "isIncluded"

    },
    "FwHelper\0getHardwares\0\0hw\0getFirmwares\0"
    "getBootloaders\0uploadFirmware\0filename\0"
    "VescInterface*\0vesc\0isBootloader\0"
    "isIncluded"
};
...
void FwHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FwHelper *_t = static_cast<FwHelper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 3: { QVariantMap _r = _t->getBootloaders((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QVariantMap*>(_a[0]) = std::move(_r); }  break;
        case 4: { bool _r = _t->uploadFirmware((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< VescInterface*(*)>(_a[2])),(*reinterpret_cast< bool(*)>(_a[3])),(*reinterpret_cast< bool(*)>(_a[4])));
...
const QMetaObject FwHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FwHelper.data,
      qt_meta_data_FwHelper,  qt_static_metacall, nullptr, nullptr}
};
