...
public:
    ...
    {
        PageBldc->setWindowTitle(QApplication::translate("PageBldc", "Form", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("PageBldc", "General", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("PageBldc", "Sensorless", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("PageBldc", "Sensors", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("PageBldc", "Advanced", Q_NULLPTR));
    } // retranslateUi
