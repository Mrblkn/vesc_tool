...
public:
    ...
    {
        PageMotorSettings->setWindowTitle(QApplication::translate("PageMotorSettings", "Form", Q_NULLPTR));
        motorSetupWizardButton->setText(QApplication::translate("PageMotorSettings", "Motor Setup Wizard", Q_NULLPTR));
    } // retranslateUi
